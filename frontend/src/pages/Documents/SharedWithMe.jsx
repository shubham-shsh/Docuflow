...
import { getSharedWithMe, deleteDocument } from "../../services/documentApi";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Loading shared documents...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Documents that others have shared with you</p>
          </div>
        ...
        {filteredDocuments.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">
              {searchTerm ? "No documents found" : "No shared documents"}
            </h3>
                  ...
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500 mt-1">
                        ...
                        {doc.sharedBy && (
                          <span>👤 Shared by {doc.sharedBy.name || doc.sharedBy.email}</span>
                        )}
                      </div>
                    </div>
                  </div>
        ...
        {filteredDocuments.length > 0 && (
          <div className="text-center mt-8">
            <p className="text-gray-500">
              Showing {filteredDocuments.length} of {documents.length} shared documents
            </p>
          </div>
        )}
      </div>
